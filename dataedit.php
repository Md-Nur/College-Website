...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
        <a class="navbar-brand" href="#">
            <img src="icon.png" width="50" height="50" alt="Edit/Show" loading="lazy">
        </a>
    ...
    if (isset($_REQUEST['s0'])) {
        ...
        $dbc0 = mysqli_connect('localhost', 'root', '', 'college'); //database
        // data base connection
    ...
    if (isset($_REQUEST['s2'])) {
        ...
        $r3 = mysqli_query(mysqli_connect('localhost', 'root', '', 'college'), $q3);
        ...
        if ($c3 > 0) {
            ...
            $r4 = mysqli_query(mysqli_connect('localhost', 'root', '', 'college'), $q4);
