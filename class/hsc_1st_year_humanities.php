...
<head>
    ...
    <title>HSC 1st Year (Humanities)</title>
    <style>
        .header {
            display: flex;
        ...
        @media(max-width:768px) {
            .header {
                ...
                color: white;
                background-position: center;
                background-image: linear-gradient(-50deg, rgba(0, 0, 0, 1), rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0)), url('../img/college/c6.jpg');
                padding: 25px;
                text-align: right;
                font-family: algerian;
...
<body>
    ...
    <div class="header" id="Home">
        ...
        <div class="an10">HSC 1st Year (Humanities)</div>
    </div>
    <div class="notice">
        ...
        $sw = "SELECT * FROM `news` WHERE `Batch` = 'HSC 1st Year (Humanities)'";
    ...
    <div class="option an5" id="reg">
        ...
        $sw5 = "SELECT * FROM `news` WHERE `Batch` = 'HSC 1st Year (Humanities)'";
    ...
    <div class="ytv">
        ...
        <table class="table table-striped table-dark an4" style="margin: 3vw; background-color:#00838a;">
            <tbody>
                ...
                $show = "SELECT * FROM `z_hsc_1st_year_humanities`";
