...
<head>
    ...
    <title>HSC 2nd Year (Science)</title>
    <style>
        .header {
            display: flex;
            ...
            background-image: linear-gradient(-50deg, rgba(0, 0, 0, 1), rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0)), url('../img/college/c7.jpg');
            padding: 50px;
            text-align: right;
...
<body>
    ...
    <div class="header" id="Home">
        ...
        <div class="an10">HSC 2nd Year (Science)</div>
    </div>
    <div class="notice">
        ...
        $sw = "SELECT * FROM `news` WHERE `Batch` = 'HSC 2nd Year (Science)'";
    ...
    <div class="option an5" id="reg">
        ...
        $sw5 = "SELECT * FROM `news` WHERE `Batch` = 'HSC 2nd Year (Science)'";
    ...
    <div class="ytv">
        ...
        <table class="table table-striped table-dark an4" style="margin: 3vw; background-color:#00838a;">
            <tbody>
                ...
                $show = "SELECT * FROM `z_hsc_2nd_year_science`";
