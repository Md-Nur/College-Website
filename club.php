...
<head>
    ...
    <style>
        .header {
            ...
            background-image: radial-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0)), url('c1.jpg');
            padding: 50px;
        ...
        @media(max-width:768px) {
            .header {
                ...
                color: white;
                background-position: center;
                background-image: radial-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0)), url('c7.jpg');
                padding: 25px;
                text-align: center;
                font-family: algerian;
            }
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
        <a class="navbar-brand" href="#">
            <img src="icon.png" width="50" height="50" alt="Clubs" loading="lazy">
        </a>
    ...
    <div class="ytx an602">
        <img class="et an801" src="c12.jpg">
    ...
    <div class="ytx an603">
        ...
        <img class="et an901" src="c13.jpg">
    </div>
    <br>
    <!-- pair club -->
    ...
    <div class="ytx an604">
        <img class="et an802" src="c14.jpg">
    ...
    <div class="ytx an605">
        ...
        <img class="et an902" src="c15.jpg">
    </div>
    <br>
    <!-- pair club -->
