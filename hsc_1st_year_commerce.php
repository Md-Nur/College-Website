...
<head>
    ...
    <style>
        .header {
            ...
            background-image: linear-gradient(-50deg, rgba(0, 0, 0, 1), rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0)), url('c3.jpg');
            padding: 50px;
            text-align: right;
        ...
        @media(max-width:768px) {
            .header {
                ...
                color: white;
                background-position: center;
                background-image: linear-gradient(-50deg, rgba(0, 0, 0, 1), rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0)), url('c8.jpg');
                padding: 25px;
                text-align: right;
                font-family: algerian;
